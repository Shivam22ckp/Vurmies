...
class Itemde extends StatefulWidget {
  Itemde({Key? key}) : super(key: key);

  @override
  _ItemdeState createState() => _ItemdeState();
}

class _ItemdeState extends State<Itemde> {
  ...
  getAdminOrders() async {
    serviceStream = await DatabaseMethods()
        .getServiceProvider(_isLoading ? "Physical" : "Virtual", "item");
    setState(() {});
  }

...
class Autode extends StatefulWidget {
  Autode({Key? key}) : super(key: key);

  @override
  _AutodeState createState() => _AutodeState();
}

class _AutodeState extends State<Autode> {
  ...
  getAdminOrders() async {
    serviceStream = await DatabaseMethods()
        .getServiceProvider(_isLoading ? "Used" : "New", "Auto");
    setState(() {});
  }

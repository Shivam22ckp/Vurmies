...
class Mixde extends StatefulWidget {
  Mixde({Key? key}) : super(key: key);

  @override
  _MixdeState createState() => _MixdeState();
}

class _MixdeState extends State<Mixde> {
  ...
  getAdminOrders() async {
    serviceStream = await DatabaseMethods()
        .getServiceProvider(_isLoading ? "Jobs" : "Workers", "mix");
    setState(() {});
  }
